...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'this is an library for the label provides a link.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/saly2310/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'saly2310' => 'vtkimsa@gmail.com' }
  s.source           = { :git => 'https://github.com/saly2310/BlinkingLabel.git', :tag => s.version.to_s }
